...
#define SETTINGS_H
  ...
  */
  ...
  #define SENSOR_ID_1 639176
  #define SENSOR_ID_2 612470
  #define FREQUENCY 867998016
  ...
  #define MQTT_STATUS_TOPIC_1 "EspSparsnasGateway/values"
  #define MQTT_DEBUG_TOPIC "EspSparsnasGateway/debug"
  #define MQTT_STATUS_TOPIC_2 "EspSparsnasGateway_1/values"
  #define MQTT_DEBUG_TOPIC_2 "EspSparsnasGateway_1/debug"
